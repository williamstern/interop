    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gps_position', models.ForeignKey(to='auvsi_suas.GpsPosition')),
            ],
        ),
        migrations.CreateModel(
            name='Waypoint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('accesslog_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='auvsi_suas.AccessLog')),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='missionconfig_mission_waypoints', to='auvsi_suas.Waypoint'),
        ),
        migrations.AddField(
            model_name='missionconfig',
            name='off_axis_target_pos',
            field=models.ForeignKey(related_name='missionconfig_off_axis_target_pos', to='auvsi_suas.GpsPosition'),
        ),
        migrations.AddField(
            model_name='missionconfig',
            name='search_grid_points',
            field=models.ManyToManyField(related_name='missionconfig_search_grid_points', to='auvsi_suas.Waypoint'),
        ),
        migrations.AddField(
            model_name='missionconfig',
            name='sric_pos',
            field=models.ForeignKey(related_name='missionconfig_sric_pos', to='auvsi_suas.GpsPosition'),
        ),
        migrations.AddField(
            model_name='flyzone',
            name='boundary_pts',
