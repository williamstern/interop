    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name=
                                    'missionconfig_off_axis_target_pos',
                                    to='auvsi_suas.GpsPosition'), ),
        migrations.AddField(
            model_name='missionconfig',
            name='search_grid_points',
            field=models.ManyToManyField(related_name=
                                         'missionconfig_search_grid_points',
                                         to='auvsi_suas.Waypoint'), ),
        migrations.AddField(
            model_name='missionconfig',
            name='sric_pos',
            field=models.ForeignKey(related_name='missionconfig_sric_pos',
                                    to='auvsi_suas.GpsPosition'), ),
        migrations.AddField(
            model_name='flyzone',
            name='boundary_pts',
