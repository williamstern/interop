        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID',
                                        ...
                                        auto_created=True,
                                        primary_key=True)),
                ('target_type', models.IntegerField(choices=[(
                    1, b'standard'), (2, b'qrc'), (3, b'off_axis'), (
                        4, b'emergent'), (5, b'ir')])),
                ...
                ('shape', models.IntegerField(
                    ...
                    choices=[(1, b'circle'), (2, b'semicircle'), (
                        3, b'quarter_circle'
                    ), (4, b'triangle'), (5, b'square'), (6, b'rectangle'), (
                        7, b'trapezoid'), (8, b'pentagon'), (9, b'hexagon'), (
                            10, b'heptagon'), (11, b'octagon'), (12, b'star'),
                             (13, b'cross')])),
                ...
                ('location', models.ForeignKey(to='auvsi_suas.GpsPosition',
                                               null=True)),
