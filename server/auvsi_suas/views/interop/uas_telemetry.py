...
from auvsi_suas.models import UasTelemetry as UasTelemetryModel
...
class UasTelemetry(View):
    ...
    def dispatch(self, *args, **kwargs):
        return super(UasTelemetry, self).dispatch(*args, **kwargs)
    ...
    def post(self, request):
        try:
            ...
            telemetry = UasTelemetryModel(user=request.user,
                                          uas_position=apos,
